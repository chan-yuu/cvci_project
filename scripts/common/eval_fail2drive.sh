...
_routes=src/lead/routes/benchmark_routes/fail2drive/Base_Animals_0075.xml
...
export PYTHONPATH=3rd_party/leaderboard/fail2drive/leaderboard:$PYTHONPATH
export PYTHONPATH=3rd_party/leaderboard/fail2drive/scenario_runner:$PYTHONPATH
export SCENARIO_RUNNER_ROOT=3rd_party/leaderboard/fail2drive/scenario_runner
...
CUDA_VISIBLE_DEVICES=0 python3 3rd_party/leaderboard/fail2drive/leaderboard/leaderboard/leaderboard_evaluator.py \
    --routes=$_routes \
    --track=SENSORS \
