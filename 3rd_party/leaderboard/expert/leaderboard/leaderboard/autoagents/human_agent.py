...
class HumanAgent(AutonomousAgent):
    ...
    def setup(self, path_to_conf_file, _, __):
        """
...
class KeyboardControl(object):
    ...
    def __init__(self, path_to_conf_file="3rd_party/leaderboard/expert/leaderboard/leaderboard/autoagents/human_agent_config.txt"):
        """
        Init
        """
