...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template name="unsupportedMigration" />
  ...
  <xsl:template name="CatalogLocations">
    <xsl:for-each select="*">
  ...
  <xsl:template name="TrafficSignals">
    <xsl:for-each select="*">
      <xsl:if test="name()=&quot;Controller&quot;">
  ...
  <xsl:template name="ObjectController">
    <xsl:for-each select="*">
      <xsl:if test="name()=&quot;CatalogReference&quot;">
        <CatalogReference>
          <xsl:call-template name="CatalogReference" />
  ...
  <xsl:template name="ByStateCondition">
    <xsl:for-each select="*">
  ...
  <xsl:template name="UserDefinedValueCondition">
    <xsl:if test="@name">
      <xsl:attribute name="name">
        <xsl:value-of select="@name" />
      </xsl:attribute>
  ...
  <xsl:template name="TimeOfDayCondition">
    <xsl:if test="@rule">
      <xsl:attribute name="rule">
        <xsl:call-template name="Rule">
          <xsl:with-param name="oldValue" select="@rule" />
  ...
  <xsl:template name="LongitudinalAction">
    <xsl:for-each select="*">
      <xsl:if test="name()=&quot;Speed&quot;">
        <SpeedAction>
  ...
  <xsl:template name="TransitionDynamics">
    <xsl:if test="@shape">
  ...
  <xsl:template name="LongitudinalDistanceAction">
    <xsl:if test="@object">
      <xsl:attribute name="entityRef">
        <xsl:value-of select="@object" />
      </xsl:attribute>
  ...
  <xsl:template name="LateralAction">
    <xsl:for-each select="*">
  ...
  <xsl:template name="LaneOffsetActionDynamics">
  ...
  <xsl:template name="LateralDistanceAction">
    <xsl:if test="@object">
      <xsl:attribute name="entityRef">
        <xsl:value-of select="@object" />
      </xsl:attribute>
  ...
  <xsl:template name="ActivateControllerAction">
  ...
  <xsl:template name="AssignControllerAction">
    <xsl:for-each select="*">
      <xsl:if test="name()=&quot;Driver&quot;">
        <Controller>
          <xsl:call-template name="Controller" />
  ...
  <xsl:template name="TrafficSourceAction">
    <xsl:if test="@rate">
  ...
  <xsl:template name="VehicleCategoryDistributionEntry">
    <xsl:if test="@category">
  ...
  <xsl:template name="ControllerDistributionEntry">
    <xsl:if test="@percentage">
      <xsl:attribute name="weight">
        <xsl:value-of select="@percentage" />
      </xsl:attribute>
  ...
  <xsl:template name="RoadCondition">
